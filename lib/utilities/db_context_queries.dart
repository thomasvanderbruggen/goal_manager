...
String createGoalMetrics = 'CREATE TABLE GoalMetrics (id INTEGER PRIMARY KEY, goalId INTEGER, title TEXT, description TEXT, percentCompleted INTEGER, FOREIGN KEY (goalid) REFERENCES Goal(id) ON DELETE CASCADE);'; 
